...
public class SelectionRecettes implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*if (source == risotto_nature){ // on peut mettre le try avant le if et tout mettre dedans
			try {
				final culinaire.structures.Recette recette_trouvee= this.getRecette("risotto"); // on récupère la recette obtenue grâce au getRecette et au nom de la recette ici "risotto"
